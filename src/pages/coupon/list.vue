    ...
    <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
      ...
      <el-table-column label="操作" width="180" align="center">
        <template #default="scope">
          <el-button size="small" v-if="scope.row.statusText === '领取中'" type="danger" plain disabled>失效中</el-button>
          <div v-else>
...
import {createCoupon, deleteCoupon, getCouponList, updateCoupon} from "../../api/coupon.js";
